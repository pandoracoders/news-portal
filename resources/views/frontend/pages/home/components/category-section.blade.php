                            ...
                            <div class="col-4 image">
                                <figure class="m-0">
                                    <a href="{{ route('singleArticle', ['slug' => $article->slug]) }}">
                                        <img src="{{ asset("image-placeholder.png") }}"   width="50" height="50" data-src="{{ asset($article->image) }}"
             ...
             <div class="biography-right col-lg-6 mt-3">
                 @foreach ($section['articles'][1] ?? [] as $key => $article)
                     <figure class="textover">
                         <img width="50" height="50" src="{{ asset("image-placeholder.png") }}" data-src="{{ asset($article->image) }}"  alt="{{ $article->title }}"
                             class="image_img">
                         <figcaption>
