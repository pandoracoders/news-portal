...
class TableSetController extends Controller
{
    ...
    public function store(TableSetRequest $request)
    {
        ...
        return redirect()->route("backend.table_set-view")->with("success", "TableSet created successfully.");
    }
    ...
    {
        $table_set?->delete();
        return redirect()->route("backend.table_set-view")->with("success", "TableSet deleted successfully.");
    }
}
